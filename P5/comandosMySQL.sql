...
--Insercion productos
INSERT INTO Producto(nombreProducto, marca, precio, cuerpo, idImagen, publicado) VALUES("Piscina para perros", "AJKMEI", 39.99, "Piscina segura y duradera para mascotas:La bañera para mascotas está hecha de tela de PVC de sabor extra resistente de alta calidad que es segura y no tóxica, duradera y resistente a los arañazos. El tablero de madera comprimido de alta resistencia de 0.45 cm de grosor incorporado agrega soporte, fortaleciendo toda la piscina y no colapsará. Bañera antideslizante y resistente para mascotas: El material del fondo está engrosado y la superficie inferior tiene una textura antideslizante y resistente al desgaste. Cuando el perro salta a la piscina o el niño juega en la niños piscina, evita que el perro y el niño se deslicen y hace que la Bañera para mascota sea más fuerte, esta piscina para perros resistirá el uso diario sin fugas ni colapsar, incluso cuando está llena. Piscina de remo para perros portátil y plegable: La piscina para baño se puede abrir y plegar fácilmente, sin necesidad de inflar, la bañera de baño fácil de transportar adopta un diseño de drenaje en espiral, gira y abre, ¡conveniente para drenar! La cubierta de drenaje está bien sellada, no hay necesidad de preocuparse por las fugas de agua. Bañera multipropósito para ducha de mascotas para niños: esta piscina para niños se puede usar en interiores y exteriores, no solo como una piscina para gatos, una bañera para perros, un estanque para peces, una bañera para bebés, bañera para niños, bar de juguetes para niños , pozos de bolas para niños, bañeras para bebés. Llenos de agua, arena o bolas de mar como un hoyo de bolas para proporcionar un buen entretenimiento para niños y mascotas, pueden divertirse juntos. Opera incluso cuando se usa bajo cero, y es adecuado para diversos entornos. Piscina de baño para perros resistente al frío y a los rayos UV: No se roms. dura más. 100% de satisfacción, proporcionamos reemplazo o reembolso y servicio al cliente de por vida, ordene su piscina de baño Kiddie con absoluta confianza. Si hay algún problema de calidad, contáctenos y le ofreceremos una solución de inmediato.",1,1);
INSERT INTO Producto(nombreProducto, marca, precio, cuerpo, idImagen, publicado) VALUES("Maiz Mordedor", "AJKMEI", 39.99, "Este es un texto de ejemplo, ya que si me pongo a buscar y a escribir cosas de cada producto, puede que me pase mas tiempo haciendo eso que haciendo la practica :). Si quiere ver como queda un texto verdadero de descripcion de producto, puede ver el producto Piscina para perros, gracias por la lectura.",2,1);
INSERT INTO Producto(nombreProducto, marca, precio, cuerpo, idImagen, publicado) VALUES("Sillon para perros", "AJKMEI", 39.99, "Este es un texto de ejemplo, ya que si me pongo a buscar y a escribir cosas de cada producto, puede que me pase mas tiempo haciendo eso que haciendo la practica :). Si quiere ver como queda un texto verdadero de descripcion de producto, puede ver el producto Piscina para perros, gracias por la lectura.",3,1);
INSERT INTO Producto(nombreProducto, marca, precio, cuerpo, idImagen, publicado) VALUES("Rastreador de mascotas", "AJKMEI", 39.99, "Este es un texto de ejemplo, ya que si me pongo a buscar y a escribir cosas de cada producto, puede que me pase mas tiempo haciendo eso que haciendo la practica :). Si quiere ver como queda un texto verdadero de descripcion de producto, puede ver el producto Piscina para perros, gracias por la lectura.",4,1);
INSERT INTO Producto(nombreProducto, marca, precio, cuerpo, idImagen, publicado) VALUES("Casa para pajaros", "AJKMEI", 39.99, "Este es un texto de ejemplo, ya que si me pongo a buscar y a escribir cosas de cada producto, puede que me pase mas tiempo haciendo eso que haciendo la practica :). Si quiere ver como queda un texto verdadero de descripcion de producto, puede ver el producto Piscina para perros, gracias por la lectura.",5,1);
INSERT INTO Producto(nombreProducto, marca, precio, cuerpo, idImagen, publicado) VALUES("Bebedor colibries", "AJKMEI", 39.99, "Este es un texto de ejemplo, ya que si me pongo a buscar y a escribir cosas de cada producto, puede que me pase mas tiempo haciendo eso que haciendo la practica :). Si quiere ver como queda un texto verdadero de descripcion de producto, puede ver el producto Piscina para perros, gracias por la lectura.",6,1);
INSERT INTO Producto(nombreProducto, marca, precio, cuerpo, idImagen, publicado) VALUES("Mochila portagatos", "AJKMEI", 39.99, "Este es un texto de ejemplo, ya que si me pongo a buscar y a escribir cosas de cada producto, puede que me pase mas tiempo haciendo eso que haciendo la practica :). Si quiere ver como queda un texto verdadero de descripcion de producto, puede ver el producto Piscina para perros, gracias por la lectura.",7,1);
INSERT INTO Producto(nombreProducto, marca, precio, cuerpo, idImagen, publicado) VALUES("Pecera", "AJKMEI", 39.99, "Este es un texto de ejemplo, ya que si me pongo a buscar y a escribir cosas de cada producto, puede que me pase mas tiempo haciendo eso que haciendo la practica :). Si quiere ver como queda un texto verdadero de descripcion de producto, puede ver el producto Piscina para perros, gracias por la lectura.",8,1);
INSERT INTO Producto(nombreProducto, marca, precio, cuerpo, idImagen, publicado) VALUES("Prenda para cobayas", "AJKMEI", 39.99, "Este es un texto de ejemplo, ya que si me pongo a buscar y a escribir cosas de cada producto, puede que me pase mas tiempo haciendo eso que haciendo la practica :). Si quiere ver como queda un texto verdadero de descripcion de producto, puede ver el producto Piscina para perros, gracias por la lectura.",9,1);
