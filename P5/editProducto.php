<?php
  ...
  include_once("BD.php");
    ...
    if ($user['rango'] >= 3) {
        ...
        echo $twig->render('editProducto.html', ['idPr' => $idPr, 'user' => $user, 'producto' => $producto, 'etiquetas' => $etiquetas, 'imagenes' => $imagenes, 'imagenesPortada' => $imagenesPortada]);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $modified['publicado'] = isset($_POST['tickeado']) ? 1 : 0;
