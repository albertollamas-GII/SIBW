<?php
    ...
    class baseDatos {
        ...
        public function updateProducto($producto){
            $stmt = $this->$conexion->prepare("UPDATE Producto SET nombreProducto = ?, marca = ?, precio = ?, cuerpo = ? WHERE idProducto = ?");
            $stmt->bind_param("ssssi", $producto['nombreProducto'], $producto['marca'], $producto['precio'], $producto['cuerpo'], $producto['id']);
            $stmt->execute();
        }
